...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://odin-project-todo-list/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   addTaskToList: () => (/* binding */ addTaskToList),\n/* harmony export */   handleAddTaskButtonClick: () => (/* binding */ handleAddTaskButtonClick)\n/* harmony export */ });\n/* harmony import */ var _domRendering__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domRendering */ \"./src/modules/domRendering.js\");\n/* harmony import */ var _createToDoTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createToDoTask */ \"./src/modules/createToDoTask.js\");\n/* harmony import */ var _listManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listManager */ \"./src/modules/listManager.js\");\n\n\n\n\nfunction addTaskToList() {\n  const form = document.querySelector('.todo-form');\n  const taskList = (0,_listManager__WEBPACK_IMPORTED_MODULE_2__.createList)();\n\n  if (form) {\n    form.addEventListener('submit', (event) => {\n      event.preventDefault();\n\n      const title = document.querySelector('.task-title-input').value;\n      const description = document.querySelector('.task-description-input').value;\n      const dueDate = document.querySelector('.task-dueDate-input').value;\n      const priority = document.querySelector('.task-priority-select').value;\n\n      const addTask = (0,_createToDoTask__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(title, description, dueDate, priority);\n      taskList.addTaskToList(addTask);\n\n      (0,_domRendering__WEBPACK_IMPORTED_MODULE_0__.renderTaskList)(taskList.taskList);\n\n      form.reset();\n    });\n  }\n}\n\nfunction handleAddTaskButtonClick() {\n    const addTaskButton = document.querySelector(\".add-task-btn\");\n  \n    addTaskButton.addEventListener(\"click\", () => {\n      (0,_domRendering__WEBPACK_IMPORTED_MODULE_0__.renderToDoTask)();\n      addTaskToList();\n    });\n  }\n  \n\n\n//# sourceURL=webpack://odin-project-todo-list/./src/modules/eventHandlers.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createList: () => (/* binding */ createList),\n/* harmony export */   deleteTask: () => (/* binding */ deleteTask)\n/* harmony export */ });\nfunction createList() {\n    const taskList = [];\n  \n    const addTaskToList = (task) => {\n      taskList.push(task);\n    };\n    return { \n      taskList, \n      addTaskToList\n    };\n  }\n\n  function deleteTask(index, taskList, renderTaskList) {\n    taskList.splice(index, 1);\n    renderTaskList(taskList);\n  }\n\n\n//# sourceURL=webpack://odin-project-todo-list/./src/modules/listManager.js?");
...
eval("module.exports = __webpack_require__.p + \"731bdba7451251353fb5.svg\";\n\n//# sourceURL=webpack://odin-project-todo-list/./src/assets/icons/add-circle-outline.svg?");
